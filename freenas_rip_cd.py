...
# TODO
# move the .mp3 directory to /mnt/mattsvol/media/Music
# put it inside a folder for the artist (or create a folder for the artist)
# (to be consistent with the iTunes setting "keep iTunes Media folder organized")
